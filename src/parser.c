...
enum ts_symbol_identifiers {
  ...
  sym__array_type = 40,
  sym_slice_type = 41,
  sym_fixed_array_type = 42,
  sym_func_call = 43,
  aux_sym_source_file_repeat1 = 44,
  aux_sym_resolve_repeat1 = 45,
  aux_sym_decl_param_list_repeat1 = 46,
  aux_sym_param_list_repeat1 = 47,
  aux_sym_scope_repeat1 = 48,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_preproc_imp] = STATE(11),
    [sym__decl] = STATE(11),
    [sym_func_decl] = STATE(11),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prim_type, 1, 0, 0),
  ...
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_call, 4, 0, 0),
  ...
  [100] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_param_list_repeat1, 2, 0, 0), SHIFT_REPEAT(25),
